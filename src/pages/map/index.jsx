...
const Map = () => {
  ...
  //     <hgroup>
  //       <h3>지도 데이터 시각화</h3>
  //       <p>Leaflet 라이브러리를 이용하여 지도 데이터 시각화를 구현합니다.</p>
  //     </hgroup>
  //     <section>
  //       <h4>필수 라이브러리 설치하기</h4>
  //       <p>
  //         React와 Leaflet을 같이 사용하기 위해서 ReactDom 라이브러리를 추가해야
  //         합니다.
  //       </p>
  ...
  //       <a href="https://react.dev/reference/react#react-dom" className="link">
  //         <span>
  ...
  //       <p>
  //         해당 CSS로 타일 맵이 잘 정렬될 수 있도록 합니다. <br /> ‼️간혹 해당
  //         스타일시트를 연결하지 않아 지도가 이상하게 보이는 경우가 발생합니다.
  //       </p>
  //     </section>
  //   </main>
  // );
